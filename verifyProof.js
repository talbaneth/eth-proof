...
console.log("pathPtr " + pathPtr + " path[pathPtr] " + path[pathPtr]);
console.log("parseInt(path[pathPtr],16) " + parseInt(path[pathPtr],16));
...
console.log("nibbles " + nibblesint);
          pathPtr += nibblesint
...
console.log("false5");
  ...
  }catch(e){ console.log(e);console.log("false6");return false }
console.log("false7");
  return false
}
